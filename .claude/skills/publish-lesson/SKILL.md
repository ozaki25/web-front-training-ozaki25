...
公開前に、レッスン本文が CLAUDE.md の執筆方針を満たしているか確認してください。特に次の点は公開直前の関所として必ずチェックすること:

- **ゴール・まとめの分量**: 「今日のゴール」と「まとめ」がそれぞれ **3項目程度（多くても4）**・各1行に収まっているか。本文の説明の繰り返しになっていないか。多い・長い場合は、分割ではなく統合して削る
- **見出し**: 名詞句・体言止めで簡潔か（「〜しよう」「〜したら」のような語り口調になっていないか）
- **長い段落**: 3文以上・複数論点の段落が箇条書き・表・図に分解されているか
