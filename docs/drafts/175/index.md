...
この型は、日々のタスクにも当てはまります。一覧に並んでいて、担当者と期限がつき、終われば完了になる、あの1件ずつのことです。
...
作るものもやり方も決まっていて、あとは手を動かすだけのタスクは、提供の作業です。図の右端にあたり、そこに届くまでに、誰かが探索・定義・展開の作業を先に片づけています。解く問題をチーム自身が選ぶ現場では、この3つもチームの中でタスクになります。
...
- どの段階の作業もタスクになり、手を動かすだけのタスクは右端の提供にあたる
