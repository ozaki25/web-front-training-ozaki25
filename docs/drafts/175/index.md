...
流れとしては、違和感や要望というきっかけがあり、そこから探索のタスクが立ちます。定義のタスクで解く問題と完了条件が決まり、展開と提供のタスクへ進みます。

閉じたあとの結果が、次のきっかけになります。

1つのきっかけから必ず4つのタスクが出るわけではありません。小さいものは1つのタスクに4段階が全部入りますし、大きいものは1段階が複数のタスクに割れます。

粒度が変わっても、どのタスクも4段階のどこかに位置することは変わりません。

やることが全部決まっているタスクは、この4種類のうち提供のものです。図の右端にあたり、そこへ届くまでに残り3種類のタスクが誰かの手で歩かれています。

## 解決策の形で届いた依頼の受け方

前半のひし形に同席しないまま、解決策の形で依頼が届くこともあります。そのときは、受け取った側から聞き返せます。
...
- タスクは4段階のどこにでも立ち、段階ごとに完了の意味が変わる
