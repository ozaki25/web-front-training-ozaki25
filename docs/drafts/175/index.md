...
この型は、作るものを決めるまでの話に限りません。やることを1件ずつタスクとして切り出すときにも、そのタスクは4段階のどこかに位置します。
...
違和感や要望に気づいた時点では、まだタスクではありません。そこからいくつのタスクが立つかは、大きさによります。

小さいものは1つのタスクに4段階が全部入りますし、大きいものは1段階が複数のタスクに割れます。粒度が変わっても、どのタスクも4段階のどこかに位置することは変わりません。

作るものもやり方も決まっていて、あとは手を動かすだけのタスクは、この4種類のうち提供のものです。図の右端にあたり、そこに届くまでに、誰かが探索・定義・展開のタスクを先に片づけています。解く問題をチーム自身が選ぶ現場では、この3種類もチームの中でタスクとして立ちます。
...
- タスクは4段階のどこにでも立ち、手を動かすだけのタスクは右端の提供にあたる
