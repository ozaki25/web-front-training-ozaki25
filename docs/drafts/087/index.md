...
「秘密を送って照合する」から「**秘密は持ったまま、持っていることだけを証明する**」へ。これがパスキーの本質的な転換です。
...
パスワードなら「人間が見分ける」必要がありました。パスキーでは「ブラウザが機械的に照合する」ので、どれだけ精巧な偽サイトでも、人間がどれだけ騙されても、署名は出ていきません。**人間の注意力という最弱のリンクが、仕組みで置き換えられた**のです。
