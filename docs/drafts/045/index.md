...
この 3 つの信号の組み合わせで、脳が「色」を作ります。3 種のうちどれかが弱い、あるいは欠けていると、特定の色の区別がつきにくくなります。これが色覚多様性です。
...
Chrome DevTools には、色覚シミュレーション機能があります。
...
自分の画面がどう見えるか、試してみると衝撃があります。「赤がエラー、緑が成功」という配色が、P 型・D 型では**ほぼ同じ色**に見えることが分かります。
