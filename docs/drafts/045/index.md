...
<svg class="c45-visible" viewBox="0 0 640 105" role="img" aria-label="可視光線の波長と色の対応。380nmが紫、450nmが青、520nmが緑、580nmが黄、620nmが橙、700nmが赤">
  ...
  <g font-family="sans-serif" font-size="15" fill="#1e293b" text-anchor="middle">
    ...
    <text x="320" y="98" fill="#475569" font-size="15">波長 (nm)</text>
  </g>
</svg>
</figure>
...
<svg class="c45-eye" viewBox="0 0 600 280" role="img" aria-label="目の断面図。光が角膜から入り、水晶体を通って網膜に届く。網膜に錐体と桿体がある">
  ...
  <g font-family="sans-serif" font-size="15" fill="#1e293b">
    ...
    <text x="305" y="144" text-anchor="middle" fill="#475569" font-size="15">硝子体</text>
    <line x1="460" y1="90" x2="422" y2="132" stroke="#94a3b8" stroke-width="1"/>
    <text x="478" y="84" text-anchor="middle" font-size="15" fill="#1e293b" font-weight="700">網膜</text>
    <text x="478" y="100" text-anchor="middle" font-size="15" fill="#475569">（錐体・桿体）</text>
...
<svg class="c45-cells" viewBox="0 0 520 160" role="img" aria-label="桿体は1種類で明暗だけ、錐体は3種類で色を識別する対比図">
  ...
  <text x="130" y="110" text-anchor="middle" font-family="sans-serif" font-size="15" fill="#475569">暗い場所で働く</text>
  <text x="130" y="128" text-anchor="middle" font-family="sans-serif" font-size="15" fill="#1e293b" font-weight="700">→ 明暗だけ</text>
  <text x="130" y="148" text-anchor="middle" font-family="sans-serif" font-size="15" fill="#475569">色は分からない</text>
  <!-- 錐体 -->
  ...
  <text x="390" y="110" text-anchor="middle" font-family="sans-serif" font-size="15" fill="#475569">明るい場所で働く</text>
  <text x="390" y="128" text-anchor="middle" font-family="sans-serif" font-size="15" fill="#1e293b" font-weight="700">→ 差を取って色を識別</text>
  <text x="390" y="148" text-anchor="middle" font-family="sans-serif" font-size="15" fill="#475569">3 種類あるから引き算できる</text>
</svg>
</figure>
...
<svg class="c45-spectrum" viewBox="0 0 760 320" role="img" aria-label="3種類の錐体の感度曲線。S錐体は短波長（青）、M錐体は中波長（緑）、L錐体は長波長（赤〜黄）にピークをもつ">
  ...
  <text x="38" y="160" text-anchor="middle" font-family="sans-serif" font-size="15" fill="#475569" transform="rotate(-90 38 160)">感度</text>
  <g font-family="sans-serif" font-size="15" fill="#1e293b" text-anchor="middle">
    ...
    <text x="390" y="310" font-size="15" fill="#475569">波長 (nm)</text>
  </g>
...
<svg class="c45-signal" viewBox="0 0 560 320" role="img" aria-label="赤い光と緑の光で錐体の信号と引き算の結果がどう変わるかの対比図。通常はL-Mの差が大きいが、P型ではLが弱く差が消える">
  ...
  <text x="280" y="305" text-anchor="middle" font-family="sans-serif" font-size="15" fill="#475569">D 型は M が弱い場合で、同じく差が消える</text>
</svg>
</figure>
...
色には色相（何色か）だけでなく、**彩度**（どれだけ鮮やかか）があります。鮮やかな赤と薄いピンクは同じ赤系ですが、彩度が違います。

チャンネルの信号の差は、彩度が高いほど大きく、低いほど小さくなります。

- **鮮やかな赤**（高彩度）: L-M の差がまだ多少残るので「何か色がある」とは感じる。ただし赤か緑かは判別できない
- **ピンク**（低彩度の赤）: もともとグレーに近く、L-M の差がわずか。その差が知覚できなければ**グレーと区別がつかない**
- **茶**（暗い橙）: 彩度が低い上に暗い。P 型では赤の明るさ自体が落ちるので、さらに黒に近づく

つまり、**色相が同じでも彩度が低い色ほど混同の範囲が広がる**。ピンクとグレー、茶と黒の混同が起きるのはこの仕組みです。
...
<svg class="c45-ellipse" viewBox="0 0 1060 500" role="img" aria-label="通常の色相環（正円）、P/D型（縦長楕円）、T型（横長楕円）の比較図">
  ...
  <text x="160" y="50" text-anchor="middle" font-family="sans-serif" font-size="15" fill="#475569">2 軸とも機能</text>
  ...
  <text x="160" y="400" text-anchor="middle" font-family="sans-serif" font-size="15" fill="#475569">赤と緑が向かい合う</text>
  <text x="160" y="416" text-anchor="middle" font-family="sans-serif" font-size="15" fill="#475569">（同じ高さ）</text>
  ...
  <text x="530" y="487" text-anchor="middle" font-family="sans-serif" font-size="15" fill="#475569">P 型では L 錐体が弱いため赤い光の明るさ自体が落ち、赤は黒に近づく</text>
</svg>
</figure>
...
<svg class="c45-caution" viewBox="0 0 520 250" role="img" aria-label="P型・D型で要注意の色の組み合わせ4つ。赤と緑、橙と黄緑（色相の混同）、赤と茶、ピンクと灰（彩度の混同）">
  ...
  <!-- 色相の混同 -->
  <text x="40" y="62" font-family="sans-serif" font-size="15" fill="#475569" font-weight="700">色相の混同</text>
  ...
  <!-- 彩度の混同 -->
  <text x="40" y="132" font-family="sans-serif" font-size="15" fill="#475569" font-weight="700">彩度の混同</text>
