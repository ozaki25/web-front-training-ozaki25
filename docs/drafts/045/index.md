...
虹の色順と同じで、物体の色はどの波長を反射するかで決まります。リンゴが赤く見えるのは、赤の波長を反射して他を吸収するためです。
...
<svg class="c45-eye" viewBox="0 0 600 280" role="img" aria-label="目の断面図。光が角膜から入り、水晶体を通って網膜に届く。網膜に錐体と桿体がある">
  ...
  <g font-family="sans-serif" font-size="15" fill="#1e293b">
    ...
    <text x="478" y="102" text-anchor="middle" font-size="15" fill="#475569">（錐体・桿体）</text>
...
<svg class="c45-signal" viewBox="0 0 560 320" role="img" aria-label="赤い光と緑の光で錐体の信号と引き算の結果がどう変わるかの対比図。通常はL-Mの差が大きいが、P型ではLが弱く差が消える">
  ...
  <text x="280" y="298" text-anchor="middle" font-family="sans-serif" font-size="15" fill="#475569">D 型は M が弱い場合で、同じく差が消える</text>
</svg>
</figure>
...
- **鮮やかな赤**（高彩度）: P 型でも L-M の差がまだ多少残るので「何か色がある」とは感じる。ただし赤か緑かは判別できない
