...
その目的のために、アプリに何を持たせるかを決めます。決めるのは、何ができるか（機能）と、何が表示されるか（情報）の2つです。

「今日やることを見失わない」ためなら、機能は追加と完了チェック、情報は今日の分のタスクです。ガントチャートや工数レポートは、この目的には要りません。

## 構造 — どの画面からどの画面へ行けるか

決めた機能と情報を、どの画面に分けて、どうつなぐかを決めます。何を押すとどの画面へ行くのか、という道順です。

一覧を開いて、その場で直して、消す。この道順が短いほど、毎日の確認が苦になりません。

逆に、1件直すのに何画面も挟むと面倒になります。

## 骨格 — 1画面のどこに何があるか

その道順にそって、1画面の中のどこに何を置くかを決めます。今日のタスクを上に、追加ボタンを親指の届く位置に、完了チェックを各行に置きます。
...
だから、作るときは下の層から手をつけます。何のためのアプリかを決め、必要な機能を決め、画面のつながりを決めてから見た目に入ると、最後まで筋が通ります。
