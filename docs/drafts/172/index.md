...
一番下が抽象的な土台で、上にいくほど具体的な見た目に近づきます。使う人に見えるのは一番上の表層だけですが、その1枚は、下の4層で決まったことの結果です。
...
この「下が上を決める」がどれだけ強いかは、一番下の戦略を差し替えてみると分かります。

同じ「タスク管理」でも、戦略が「上司がチーム全員の負荷を把握するため」だったらどうなるか。要件は各人の担当数と工数に変わり、構造は人ごとの集計に、骨格は一覧ではなく表やグラフに、表層まで別物になります。

「今日やることを見失わないため」のときとは、まったく違う画面です。一番下の一文が変わるだけで、上の4層は丸ごと入れ替わります。

見た目は、下の層で決まったことの結果であって、出発点ではありません。
...
見た目だけ磨いても直らない不具合は、たいていこの下の層に原因があります。

## 作るときは下の層から決める

だから、作るときは下の層から手をつけると筋が通ります。目的を決め、載せる情報を決め、辿り方を決めてから最後に見た目に入れば、表層まで一本の線で繋がります。

逆に見た目から始めると、その下を勘で埋めることになり、さっきの壊れ方をします。誰かに作ってもらうときも同じで、下の層を言葉にして渡すほど、出来上がりが目的からぶれません。
