...
その下には、目に見えない4つの層があります。Jesse James Garrett は『The Elements of User Experience』で、画面を戦略・要件・構造・骨格・表層の5段階に分けて説明しています。
...
Figma で手を動かすのは、5段階のうち上の2つ、骨格と表層だけです。その下の戦略・要件・構造は、Figma を開く前に決まっているべきことです。
