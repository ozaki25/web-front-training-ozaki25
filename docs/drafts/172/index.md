...
アプリでも Web サイトでも、画面を見て最初に目に入るのは色やレイアウト、つまり見た目です。けれど見た目は、画面を成り立たせている一番上の層にすぎません。

その下には、目に見えない4つの層があります。『The Elements of User Experience』(Jesse James Garrett) は、画面を戦略・要件・構造・骨格・表層の5つの層で捉えます。
