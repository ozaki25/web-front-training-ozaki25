...
「常に最新にしたい」という理由で `no-store` をあちこちに付けたコードをよく見かけます。すると、静的にできたはずのページまで動的になり、**静的化による速さを失います**。

毎回最新が本当に必要な場面は、思うほど多くありません。付ける前に確かめると無駄な動的化を避けられます。
...
| 保存あり＋再検証 | 古くなったら捨てて作り直す | 速さは維持 | 変えた後に最新へ |
