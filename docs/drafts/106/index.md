...
AI で E2E も含めてテストは書きやすくなりました。でも、E2E を絞る理由は「書くのが大変」だからではありません。**遅い・壊れやすい（flaky）・保守が重い・落ちても信じてもらえない**、が理由で、そこは生成しても消えません。AI が 100 本の E2E を一瞬で生んでも、毎朝どれか赤なら価値はマイナスです。だから選び方はこうなります。

- **静的解析・型**: タダで常時効く。AI と関係なく、まず土台を固める
- **結合**: ユーザー価値に近く、E2E より速く安定。**AI に量産させる主戦場**
- **E2E**: 書きやすくなっても、遅く壊れやすいのは変わらない。重要フロー（クリティカルパス）に絞る
