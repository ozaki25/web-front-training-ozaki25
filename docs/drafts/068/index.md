...
普段のレッスンでは、HTML・CSS・JavaScript といった「サーバーから受け取ったファイルをどう書くか」を扱っています。

今日は視点を変えて、**ブラウザ自体に組み込まれた機能**を見ていきます。アプリとしてのインストール、音声合成、AI による翻訳や要約。どれもサーバーに頼らず、ブラウザの中で完結する機能です。
