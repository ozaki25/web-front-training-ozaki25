...
もう1つ、URL に書いておくやり方もあります。`?sort=price&page=2` のような文字列は、並び順とページ番号を毎回伝えているものです。
...
| 置き場所 | 何が残るか | いつまで残るか |
|---|---|---|
| サーバー | カゴの中身、投稿、注文履歴 | 消すまで。別の端末から開いても残る |
| ブラウザ | ログイン済みの印、下書き | ブラウザを閉じても残る。その端末の中だけ |
| URL | 並び順、ページ番号、絞り込み | その URL を開いている間。人にも送れる |
