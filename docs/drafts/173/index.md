...
通販サイトで買い物をしている途中、表示の調子が悪くてリロードしたとします。すると、同じ画面の中で、消えるものと残るものに分かれます。

消えるもの:

- 書きかけだったレビューの文章
- 選んだだけでまだカゴに入れていないサイズや数量
- スクロールしていた位置
...
書きかけのレビューは消えたのに、投稿し終えたレビューは残っています。同じ自分が打った文字なのに、どこかで扱いが分かれています。
...
入力途中の文字も、選んだサイズも、スクロール位置も、今のページの上に置かれていた状態です。ページを捨てるとき、一緒に捨てられます。
...
書きかけのレビューが消えて、投稿済みのレビューが残ったのも同じ理由です。投稿ボタンを押した文字はサーバーに保存されていて、押していない文字はページの上にしかありません。
