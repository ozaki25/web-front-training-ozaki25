...
- Next.js のキャッシュが 4 つの場所で起きると知る
- それを制御するモデルに従来と新の 2 つがあると知る
- 違いが「暗黙か明示か」「どの単位で指定するか」にあると知る

## キャッシュが起きる 4 つの場所

「Next.js のキャッシュ」と一口に言っても、実際には**段階の違う 4 つの場所**でキャッシュが起きます。まずこの地図を持っておくと、個々の話が迷子になりません。
...
- キャッシュは 4 つの場所（Memoization / Data / Full Route / Router）で起きる
