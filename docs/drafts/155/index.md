...
- **人が直接書く言語ではない**: 「4 つ目の言語」と呼ばれてはいるが、開発者がこの形式を手で書くことはまずない。開発者は自分の言語で書き、WebAssembly はその**変換先**になる
...
自分の開発で思い出す価値があるのは 2 行目です。「この重い処理、サーバーに送らずブラウザ内で完結できないか」という相談が出たら、WebAssembly を使ったライブラリを探すのが選択肢になります。
