...
| 目安 | 通すもの | ひとこと |
|---|---|---|
| 全状態 | すべての箱 | 最低ライン。矢印は通り残る |
| 全遷移 | すべての矢印（埋まったマス） | もっとも一般的な目安 |
| 無効な遷移まで | 表の空欄も「起きない」と確認 | 決済・ログインなど重要機能で |

まず箱を全部、次に矢印を全部、重要な機能は「起きてはいけない移り変わり」まで。
