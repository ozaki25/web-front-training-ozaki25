...
<style>
.demo-base-select select { appearance:base-select;padding:12px 18px;border:2px solid #6366f1;border-radius:12px;font-size:1em;min-width:280px;background:linear-gradient(135deg,#fafafe,#eef0ff);color:#1e293b;cursor:pointer;font-weight:500;box-shadow:0 2px 8px rgba(99,102,241,0.2);transition:all 0.15s }
.demo-base-select select:hover { border-color:#4f46e5;box-shadow:0 4px 12px rgba(99,102,241,0.3) }
.demo-base-select select::picker(select) { border:none;border-radius:14px;padding:8px;box-shadow:0 12px 32px rgba(0,0,0,0.18);background:white;color:#1e293b }
.demo-base-select option { padding:12px 16px;border-radius:10px;font-size:0.95em;background:white;color:#1e293b;margin:2px 0 }
.demo-base-select option:hover { background:linear-gradient(135deg,#eef2ff,#e0e7ff);color:#3730a3 }
.demo-base-select option:checked { font-weight:700;background:linear-gradient(135deg,#6366f1,#4f46e5);color:white }
</style>
