...
.demo-base-select select::picker(select) { border:none;border-radius:12px;padding:6px;box-shadow:0 8px 24px rgba(0,0,0,0.15);background:white;color:#1e293b }
.demo-base-select option { padding:10px 14px;border-radius:8px;font-size:0.95em;transition:background-color 0.1s;background:white;color:#1e293b }
.demo-base-select option:hover { background-color:#eef2ff;color:#1e293b }
