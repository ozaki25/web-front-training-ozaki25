...
- CSS の役割と基本的な書き方を理解する
- セレクタ、プロパティ、値の関係を説明できる
- CSS を適用する 3 つの方法（インライン・style タグ・外部ファイル）の違いを理解する
- カスケードと詳細度の仕組みを知る
...
外部 CSS ファイルを使って、Day 1 の自己紹介ページにスタイルを当ててみましょう。
...
ブラウザで開くと、素の HTML に比べてずいぶん読みやすくなっているはずです。CSS のプロパティを変えて、色やサイズを調整してみてください。
...
**次のレッスン**: [Day 5: CSS ボックスモデルとレイアウト](/lessons/day05/)
