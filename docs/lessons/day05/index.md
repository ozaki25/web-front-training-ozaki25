...
<style>
.demo-details summary { padding:12px 16px !important;cursor:pointer !important;font-weight:600 !important;font-size:0.95em !important;box-sizing:border-box !important }
</style>
<div style="padding:20px;background:#f8fafc;border-radius:8px;border:1px solid #e2e8f0;margin:16px 0;color:#1e293b">
