...
1件のタスクが生まれてから終わるまでの流れは、そのまま4段階をなぞります。

| 段階 | タスクでやること |
|---|---|
| 探索 | やるべきことの候補を出す |
| 定義 | 何ができたら完了かを決める |
| 展開 | 進め方の案を比べて、TODO に分ける |
| 提供 | 実行して、完了条件と突き合わせる |

そのタスクが調査でも、設計でも、コーディングでも、この流れは変わりません。中身が何であれ、生み出して、完了条件を決めて、手順に落として、実行することになります。

前半のひし形で書いた問題文にあたるのが、タスクでは完了条件です。完了条件の書かれたタスクが手元に来た時点で、最初の2つは誰かが済ませています。解く問題をチーム自身が選ぶ現場では、そこも自分たちでやることになります。

その2つに加わらないまま、解決策の形で依頼が届くこともあります。そのときは、依頼が探索と定義を通ってきたのかを、2つの質問で確かめられます。
...
段階によって、AI への任せやすさも違います。完了条件も手順も決まったあとの実行は、任せられる範囲がすでに広がっています。

手前の3段階はそうはいきません。何をやるべきか、何ができたら完了か、どう進めるかは、その場の事情を知っている人でないと決められません。

人の手が要るのは、まだ決まっていないところです。
...
- 1件のタスクも4段階でできていて、AI に任せやすいのは最後の実行だけ
