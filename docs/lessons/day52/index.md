...
Day 23〜30 で React の基礎を、Day 34〜41 で Next.js の機能を学びました。小さなコンポーネントは直感的に書けるようになったと思います。
...
Day 35 で学んだ「デフォルト Server Component、必要な部分だけ Client Component」の方針は、まさにこのパターンの実践です。
...
**次のレッスン**: [Day 53: アーキテクチャ総まとめ](/lessons/day53/)
