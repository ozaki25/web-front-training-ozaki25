...
Day 13-20:  JavaScript の深掘り（DOM / 非同期 / モジュール / TypeScript）
Day 23-30:  React の基礎（JSX / コンポーネント / Hooks / 状態管理）
Day 33-41:  Next.js の基礎（SPA/SSR / App Router / RSC / データ取得 / Tailwind）
Day 44-51:  実践スキル（テスト / a11y / パフォーマンス / セキュリティ / 設計）
```
...
Day 34 で紹介した**コロケーション**（関連ファイルを近くに置く）は重要な原則です。
