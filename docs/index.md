...
設計技法は 4 本構成です。107 と 047（前編）を同じ日に、111（後編）をその次に読む想定。テスト計画は公開済みの Day 35 です。

- [107: テスト設計技法の分類](/drafts/107/) — 仕様/構造/経験の 3 系統（地図。経験ベースはここで名前だけ）
- [047: 同値分割と境界値](/drafts/047/) — ブラックボックス前編。仕様ベースで1つの値に注目する技法
- [111: デシジョンテーブルと状態遷移テスト](/drafts/111/) — ブラックボックス後編。仕様ベースで組み合わせ・状態に注目する技法
- [109: ホワイトボックステスト](/drafts/109/) — 構造ベース：カバレッジ

統合元（残置。111 に一部反映済み）: [104](/drafts/104/)・[105](/drafts/105/)
