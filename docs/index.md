...
上から順に読むのがおすすめ。「1 本のテストの中身 → 設計技法 → どこまでやるか」と積み上がります。

- [047: テストは「どの値を試すか」で決まる](/drafts/047/) — 入口。緑でも穴がある、同値分割・境界値
...
- [106: テスト計画（どこまでテストするか）](/drafts/106/) — 計画：リスクで濃淡
- [049: テストのコスト構造](/drafts/049/) — 計画：どの層に厚く（配分）
