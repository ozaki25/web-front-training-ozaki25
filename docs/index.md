...
設計技法は 3 本に集約する方針です。統合元の細かい下書きは残置しています。テスト計画は公開済みの Day 35 です。

- [107: テスト設計技法の分類](/drafts/107/) — 仕様/構造/経験の 3 系統（地図。経験ベースはここで名前だけ）
- [111: ブラックボックステスト](/drafts/111/) — 仕様ベース 4 技法を 1 本に統合（同値分割・境界値・デシジョンテーブル・状態遷移）
- [109: ホワイトボックステスト](/drafts/109/) — 構造ベース：カバレッジ

統合元（残置。111 にまとめ済み）: [047](/drafts/047/)・[104](/drafts/104/)・[105](/drafts/105/)
