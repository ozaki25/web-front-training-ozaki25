...
- [Day 40: ホワイトボックステスト — ステートメントとデシジョンのカバレッジ](/lessons/day40/)
...
- [Day 47: 同期通信と非同期通信 — ページが移るか、移らないか](/lessons/day47/)
- [Day 48: Web はステートレス — リロードすると消えるものと消えないもの](/lessons/day48/)
- [Day 49: コンポーネントテストの書き場所 — Story に書くか、テストファイルに書くか](/lessons/day49/)
- [Day 50: ダブルダイヤモンド — 解決策の前に問題を決める](/lessons/day50/)
- [Day 51: サーバーから渡したデータは全部見える — 表示しないフィールドも HTML に載る](/lessons/day51/)
- [Day 52: Tiptap — 見た目は自分で作るリッチテキストエディタ](/lessons/day52/)
- [Day 53: フィーチャーフラグ — コードを出すことと機能を見せることを分ける](/lessons/day53/)
- [Day 54: AI-DLC — AI が計画を立て、人間が承認する開発サイクル](/lessons/day54/)

## 候補（下書き）

### JS の基礎

- [005: 関数とコールバック](/drafts/005/)
- [006: Promise](/drafts/006/)
- [086: async/await](/drafts/086/)
- [017: React コードを読むための JS 構文](/drafts/017/)
- [018: 配列操作と JSX のリスト](/drafts/018/)
- [029: イベントループ](/drafts/029/)
- [025: スコープとクロージャ](/drafts/025/)
- [085: 日付とタイムゾーンの罠](/drafts/085/)
- [084: URL の解剖](/drafts/084/)
- [103: JSON](/drafts/103/)
- [115: IME変換中のEnter](/drafts/115/)
- [129: debounce と throttle](/drafts/129/)
- [137: ハッシュテーブル](/drafts/137/)
...
- [019: JSX と props](/drafts/019/)
- [020: JSX の仕組み](/drafts/020/)
...
- [083: エラーバウンダリ](/drafts/083/)
- [030: イベントの仕組み](/drafts/030/)
- [031: データ取得ライブラリ](/drafts/031/)
- [116: 楽観的更新](/drafts/116/)
- [122: 競合状態](/drafts/122/)
- [130: メモリリーク](/drafts/130/)
- [145: 純粋関数](/drafts/145/)

### Next.js / App Router

- [013: ハイドレーション](/drafts/013/)
- [033: Server / Client Components](/drafts/033/)
- [034: App Router のファイル規約](/drafts/034/)
- [035: SC でのデータ取得](/drafts/035/)
...
- [164: リダイレクトの仕組み](/drafts/164/)
- [165: Content-Type と MIME](/drafts/165/)
- [036: CORS](/drafts/036/)
...
- [162: 圧縮](/drafts/162/)
- [166: Base64 と Data URL](/drafts/166/)
...
- [023: Tailwind CSS の仕組み](/drafts/023/)
- [076: カスケードと詳細度](/drafts/076/)
- [077: モダン CSS](/drafts/077/)
- [078: ダークモードの仕組み](/drafts/078/)
- [119: スタッキングコンテキスト](/drafts/119/)
...
- [133: タッチターゲット](/drafts/133/)
- [142: ズームとリフロー](/drafts/142/)
- [167: APCA](/drafts/167/)
...
- [087: パスキー](/drafts/087/)
- [054: npm サプライチェーン](/drafts/054/)
- [132: CSP](/drafts/132/)
- [134: サードパーティスクリプトの信頼範囲](/drafts/134/)
- [139: パスワードの保存](/drafts/139/)
- [143: クリックジャッキング](/drafts/143/)
- [144: JWTは誰でも読める](/drafts/144/)
- [148: IDOR](/drafts/148/)
- [150: SQL インジェクション](/drafts/150/)

### テスト設計・計画

設計技法は 4 本構成で、分類（Day 36）・前編（Day 37）・後編（Day 38）・構造ベース（Day 40）まで公開済み。テスト計画は公開済みの Day 35 です。

- [168: テストの7つの原則](/drafts/168/)

統合元（残置。Day 38 に一部反映済み）: [104](/drafts/104/)・[105](/drafts/105/)
保留: [110 基礎](/drafts/110/)（外す方針）・[108 経験ベース](/drafts/108/)（個別化しない）

### テストの実装・ツール

設計・計画のあと、実際に書くときの道具。上から順に。

- [048: Testing Library](/drafts/048/) — 結合テストの主戦場
- [090: モックと MSW](/drafts/090/) — 依存を切り離す
- [046: E2E テスト](/drafts/046/) — 端から端まで自動操縦
- [120: プロパティベーステスト](/drafts/120/) — 例ではなく性質を書く
- [135: 壊し方のカタログ](/drafts/135/)

### パフォーマンスと観測

- [058: Web Vitals](/drafts/058/)
- [059: バンドルサイズ](/drafts/059/)
- [061: next/image と next/font](/drafts/061/)
- [102: レンダリングパイプライン](/drafts/102/)
- [082: フロントエンドの可観測性](/drafts/082/)
- [118: ソースマップ](/drafts/118/)
- [131: N+1とウォーターフォール](/drafts/131/)
- [140: 計算量とO記法](/drafts/140/)
- [149: フォントの遅延](/drafts/149/)
- [154: 巨大リストの仮想化](/drafts/154/)

### 型

- [069: TypeScript の型を読む](/drafts/069/)
- [070: 構造的型付け](/drafts/070/)
- [071: 型は実行時に消える](/drafts/071/)
- [099: strict の仕組み](/drafts/099/)
- [121: as const と satisfies](/drafts/121/)

### 開発環境

- [062: npm run の仕組み](/drafts/062/)
- [063: HMR](/drafts/063/)
- [081: ESM とバンドラー](/drafts/081/)
- [064: ビルドとデプロイ](/drafts/064/)
...
- [138: コールドスタート](/drafts/138/)
- [153: ロードバランサ](/drafts/153/)
- [127: 結果整合性](/drafts/127/)

### 設計とコードの読み書き

- [066: コンポーネントの責務分割](/drafts/066/)
- [067: 命名という設計](/drafts/067/)
- [068: コロケーション](/drafts/068/)

### UX・デザイン

- [072: ダークパターン](/drafts/072/)
- [073: UI デザインの法則](/drafts/073/)
- [074: OOUI](/drafts/074/)
- [075: デザインシステムの実装](/drafts/075/)
- [128: 取り消せる設計](/drafts/128/)
- [141: ローディングの見せ方](/drafts/141/)
- [147: エンプティステート](/drafts/147/)
- [171: UI の状態](/drafts/171/)

### AI との協働

- [055: AI コーディングとの付き合い方](/drafts/055/)
- [056: MCP](/drafts/056/)
- [057: コンテキストウィンドウ](/drafts/057/)
- [113: AIとの協働モード](/drafts/113/)
