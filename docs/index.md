...
各レッスンは単独でも読めます。基礎から積み上げるなら上から順（テストとは何か → 1 本のテストの中身 → 設計技法）、必要なテーマ（たとえばテスト計画）から入るのもありです。

- [110: そもそもテストとは何か](/drafts/110/) — 入口。期待と実際の突き合わせ、なぜテストするのか
- [047: テストは「どの値を試すか」で決まる](/drafts/047/) — 緑でも穴がある、同値分割・境界値
- [107: テスト設計技法の分類](/drafts/107/) — 仕様/構造/経験の 3 系統（地図）
- [104: デシジョンテーブル](/drafts/104/) — 仕様ベース：条件の組み合わせ
- [105: 状態遷移テスト](/drafts/105/) — 仕様ベース：状態と移り変わり
- [109: ホワイトボックステスト](/drafts/109/) — 構造ベース：カバレッジ
- [108: 経験ベースのテスト技法](/drafts/108/) — 経験ベース：勘で狙う
- [106: テスト計画（工数をどこにかけるか）](/drafts/106/) — 計画：リスク（機能）と層（ピラミッド/トロフィー）、AI 時代の選び方
