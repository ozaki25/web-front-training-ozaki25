...
設計技法は 4 本構成です。分類（Day 36）・前編（Day 37）は公開済み。111（後編）をその次に読む想定。テスト計画は公開済みの Day 35 です。

- [111: デシジョンテーブルと状態遷移テスト](/drafts/111/) — ブラックボックス後編。仕様ベースで組み合わせ・状態に注目する技法（PR作成済み）
