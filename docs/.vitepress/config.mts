      ...
      themeConfig: {
        ...
        sidebar: [
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: "Day 5: 専用の HTML 要素で作れる UI", link: "/drafts/001/" },
              { text: "CSS の基本と適用方法", link: "/drafts/002/" },
              { text: "CSS ボックスモデルとレイアウト", link: "/drafts/003/" },
              { text: "Flexbox", link: "/drafts/004/" },
              { text: "CSS Grid", link: "/drafts/005/" },
              { text: "レスポンシブデザインと CSS の課題", link: "/drafts/006/" },
              { text: "JavaScript の基本文法", link: "/drafts/007/" },
              { text: "関数とスコープ", link: "/drafts/008/" },
              { text: "オブジェクトと配列", link: "/drafts/009/" },
              { text: "DOM 操作", link: "/drafts/010/" },
              { text: "非同期処理", link: "/drafts/011/" },
              { text: "HTTP とネットワーク基礎", link: "/drafts/012/" },
              { text: "ES Modules", link: "/drafts/013/" },
