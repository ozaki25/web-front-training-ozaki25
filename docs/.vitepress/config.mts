      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "15: 横に並べたい（Flexbox）", link: "/html-candidates/15/" },
            { text: "16: なぜスタイルが効かない（適用ルール）", link: "/html-candidates/16/" },
            { text: "17: 画面幅で見た目を変えたい（レスポンシブ）", link: "/html-candidates/17/" },
            { text: "18: 余白がおかしい（ボックスモデル）", link: "/html-candidates/18/" },
            { text: "19: スタイルが衝突する（スコープ）", link: "/html-candidates/19/" },
            { text: "20: 要素を好きな位置に（ポジショニング）", link: "/html-candidates/20/" },
            { text: "21: 見た目を動かしたい（アニメーション）", link: "/html-candidates/21/" },
            { text: "22: グリッド状に並べたい（Grid）", link: "/html-candidates/22/" },
            { text: "23: カードごとにレイアウト切替（コンテナクエリ）", link: "/html-candidates/23/" },
            { text: "24: 中央寄せしたい（歴代手法）", link: "/html-candidates/24/" },
            { text: "25: ダークモード対応（カスタムプロパティ）", link: "/html-candidates/25/" },
            { text: "26: hover/focus（疑似クラス）", link: "/html-candidates/26/" },
            { text: "27: レイアウトがはみ出す（overflow）", link: "/html-candidates/27/" },
            { text: "28: スクロールで固定（sticky/scroll-snap）", link: "/html-candidates/28/" },
            { text: "29: 値を何度も書きたくない（カスタムプロパティ設計）", link: "/html-candidates/29/" },
          ],
        },
      ],
      outline: {
