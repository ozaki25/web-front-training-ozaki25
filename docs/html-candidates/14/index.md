...
<p style="margin:8px 0 0;font-size:0.9em">画像内に読めるテキストがある → <strong>そのテキストを書く</strong><br><code style="color:#1e293b;background:#e2e8f0;padding:2px 6px;border-radius:3px">alt="OPEN"</code></p>
</div>
