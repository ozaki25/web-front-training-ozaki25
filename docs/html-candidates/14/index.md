...
<div style="font-weight:700;margin-bottom:8px">ケース1: テキストが含まれたロゴ画像</div>
<img src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20width='220'%20height='56'%20viewBox='0%200%20220%2056'%3E%3Crect%20width='220'%20height='56'%20rx='8'%20fill='%231e293b'/%3E%3Ctext%20x='110'%20y='36'%20text-anchor='middle'%20font-family='sans-serif'%20font-size='20'%20font-weight='bold'%20fill='%23fbbf24'%3E%E7%8C%AB%E3%82%AB%E3%83%95%E3%82%A7%20%E3%81%AB%E3%82%83%E3%82%93%E3%81%93%3C/text%3E%3C/svg%3E" alt="猫カフェ にゃんこ" width="220" height="56" style="border-radius:8px;display:block;margin:4px 0" />
<p style="margin:8px 0 0;font-size:0.9em">ロゴ画像にサービス名が含まれている → <strong>そのテキストを書く</strong><br><code style="color:#1e293b;background:#e2e8f0;padding:2px 6px;border-radius:3px">alt="猫カフェ にゃんこ"</code></p>
</div>
