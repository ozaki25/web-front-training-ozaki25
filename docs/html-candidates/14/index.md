...
<div style="font-weight:700;margin-bottom:8px">ケース1: 「OPEN」と書かれた看板の写真</div>
<svg width="120" height="80" viewBox="0 0 120 80" style="margin:4px 0" role="img" aria-label="OPEN と書かれた吊り看板"><rect x="10" y="15" width="100" height="55" rx="6" fill="#fef3c7" stroke="#d97706" stroke-width="2"/><text x="60" y="50" text-anchor="middle" font-family="sans-serif" font-size="24" font-weight="bold" fill="#92400e">OPEN</text><line x1="40" y1="15" x2="40" y2="5" stroke="#78716c" stroke-width="2"/><line x1="80" y1="15" x2="80" y2="5" stroke="#78716c" stroke-width="2"/><line x1="30" y1="5" x2="90" y2="5" stroke="#78716c" stroke-width="2"/></svg>
<p style="margin:8px 0 0;font-size:0.9em">画像内に読めるテキストがある → <strong>そのテキストを書く</strong><br><code>alt="OPEN"</code></p>
</div>
...
<p style="margin:8px 0 0;font-size:0.9em">周辺のテキストに同じ情報がある → <strong><code>alt=""</code></strong> で二重読み上げを防ぐ</p>
</div>
...
<p style="margin:8px 0 0;font-size:0.9em">複雑な画像は alt だけでは伝えきれない → <strong>短い alt + 別途詳細を記載</strong><br><code>alt="月別来店者数のグラフ。詳細は下の表を参照"</code></p>
</div>
