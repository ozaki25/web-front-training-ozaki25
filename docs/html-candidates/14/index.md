...
<img src="https://images.unsplash.com/photo-1526336024174-e58f5cdd8e13?w=300&h=200&fit=crop" alt="店内でくつろぐ猫" width="300" height="200" style="border-radius:8px;margin:8px 0" />

- 猫カフェの紹介 → `alt="店内でくつろぐ猫"`
...
CSS で表示サイズを変えても、縦横比が保たれて高さが自動調整されます。
