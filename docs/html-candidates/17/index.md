...
<style>
.c17-demo-mq{border:1px solid #cbd5e1;border-radius:8px;padding:1.25rem;background:#fef3c7;color:#1e293b;font-weight:bold;}
.c17-demo-mq::before{content:"📱 狭い画面 (< 768px)";display:block;margin-bottom:0.5rem;font-size:0.85rem;color:#475569;}
@media (min-width: 768px){
  .c17-demo-mq{background:#dbeafe;}
  .c17-demo-mq::before{content:"🖥️ 広い画面 (>= 768px)";}
}
</style>

<div class="c17-demo-mq">画面幅に応じて背景色が切り替わる</div>
