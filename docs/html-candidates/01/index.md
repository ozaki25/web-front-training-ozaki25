...
`<h1>` はそのページで最も重要な見出しです。ページに1つ、そのページ固有のタイトルを h1 にするのが一般的です。
...
<!-- ✅ サイト名は h1 にせず、ページ固有のタイトルを h1 にする -->
<header>
...
`<section>` や `<article>` の直下に置いた見出しは、そのセクション全体のタイトルになります。
...
<main>
  ...
  <section>
    <h2>和食</h2>           <!-- このセクション全体の見出し -->
    <p>和食の代表的なレシピを紹介します。</p>
    <h3>肉じゃが</h3>       <!-- 「和食」セクションの中の小見出し -->
    <p>材料：じゃがいも、牛肉、にんじん...</p>
    <h3>味噌汁</h3>         <!-- 同じく「和食」の中の小見出し -->
    <p>材料：豆腐、わかめ、味噌...</p>
  </section>
...
セクショニングタグと見出し階層を組み合わせることで、ページの構造がより明確になります。`<section>` がコンテンツの「まとまり」を示し、見出しがその「タイトル」を示す ── この2つはセットで使うのが自然です。
