...
<style>
.c23-slot { container-type: inline-size; }
.c23-card {
  display: flex;
  flex-direction: column;
  gap: 8px;
...
.c23-title { margin: 0; font-size: 14px; color: #1e293b; }
.c23-sub { margin: 4px 0 0; font-size: 12px; color: #475569; }
@container (min-width: 400px) {
  .c23-card { flex-direction: row; align-items: center; gap: 16px; padding: 16px; }
  .c23-avatar { width: 80px; height: 80px; aspect-ratio: auto; }
  .c23-title { font-size: 18px; }
  .c23-sub { font-size: 14px; }
}
</style>
...
<div style="display:flex;gap:16px;flex-wrap:wrap;background:#f8fafc;color:#1e293b;padding:16px;border-radius:8px;border:1px solid #e2e8f0;">
  <div style="background:white;color:#1e293b;padding:12px;border-radius:8px;border:1px solid #cbd5e1;">
    ...
    <div class="c23-slot" style="width:200px;">
      <article class="c23-card">
        <div class="c23-avatar" aria-hidden="true"></div>
        <div>
          <h4 class="c23-title">山田 太郎</h4>
          <p class="c23-sub">フロントエンドエンジニア</p>
        </div>
      </article>
    </div>
  </div>
  ...
  <div style="background:white;color:#1e293b;padding:12px;border-radius:8px;border:1px solid #cbd5e1;flex:1;min-width:280px;">
    ...
    <div class="c23-slot" style="width:100%;">
      <article class="c23-card">
        <div class="c23-avatar" aria-hidden="true"></div>
        <div>
          <h4 class="c23-title">山田 太郎</h4>
